...
// {/* <div className="relative justify-center lg:w-full h-[718px]"> */}
...
//     className=" sm:w-[500px] md:w-[700px] lg:w-full object-cover"
//   />
...
//                   Unde, ipsam veritatis optio autem quam consectetur labore
//                   eaque excepturi esse blanditiis corrupti sequi sapiente
...
//         <div className="flex w-[1440px] h-[625px] bg-[#f2eeee] text-black mt-2 items-center">
//           <div>
//             <h2 className="font-extrabold justify-left text-2xl">
//               50 + Beautiful
//             </h2>
//             <h2 className="font-extrabold justify-left text-2xl">
//               rooms inspiration
...
//           <div className="flex sm-[justify-center mt-2 items-center">
//             <Image
//               src="/innerpeace.png"
//               alt="INNER PEACE"
//               width={404}
...
//           {/* Rectangle Image */}
//           <div
//             className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] max-w-[643px] h-[50%] bg-[#FFF3E3] flex flex-col justify-start items-start p-6"
//           >
//             <p className="text-sm text-gray-500 mb-4">New Arrival</p>
...
//           <div
//             className="absolute top-1/2 right-[5%] transform -translate-y-1/2 w-[80%] max-w-[643px] 
//             h-[50%] bg-[#FFF3E3] mr-[100px] flex flex-col justify-start items-start 
//              md-p-6"
//           >
...
// <h2 className="text-[#B88E2F] lg:font-extrabold  text-xl sm:text-sm md:text-lg lg:text-2xl mb-4 
...
//             <ul className="text-[#000000]">
//               <li className="mb-4 text-sm md:text-lg lg:text-xl">
//                 Lorem ipsum, dolor sit amet consectetur adipisicing elit.
//                 Unde, ipsam veritatis optio autem quam consectetur labore
//                 eaque excepturi esse blanditiis corrupti sequi sapiente
//                 aliquid quibusdam alias, mollitia quisquam, perferendis vitae!
...
//             </ul>
//             <Link href="/product">
//               <button className="mt-6 w-[222px] h-[50px] rounded-sm bg-[#B88E2F] text-white sm:text-lg font-medium">
//                 BUY NOW
//               </button>
//             </Link>
//           </div>
